...
function showModalAtividade(atividade) {
    ...
    modalTxt.innerHTML = `<h4>${atividade.nomeAtividade}</h4><p>${atividade.descricao}</p>`;
    ...
    if (atividade.tipoAtividade === 'videoAula') {
        ...
        modalTxt.innerHTML +=  '<object data="'+ url_files + atividade.idAtividade + '/' + atividade.url +'" type="application/pdf" width="800px" height="600px"></object>'
