...
class ViewAtividade
{
    ...
    public function index(int|string|null $id = null): void
    {
        if (!empty($id)) {
            ...
            $viewAtividade = new \Public\Models\PublicView();
            ...
            if ($viewAtividade->getResult()) {
                ...
                $urlRedirect = URL . "list-atividades/index";
                header("Location: $urlRedirect");
            }
        } else {
            $_SESSION['msg'] = "<p style='color: red'>Erro: Atividade não encontrada!</p>";

            $urlRedirect = URL . "list-ativiades/index";
            header("Location: $urlRedirect");
        }
    }
    ...
    private function loadView(): void
    {
        ...
        $loadView = new \Core\ConfigView("Views/atividades/viewAtividade", $this->data);
        $loadView->loadView();
    }
}